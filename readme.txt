...
* CHANGE - Apply restrictions to the Google Feed created by the plugin google-product-feed
			
= 1.15.1 - 2024-04-03 =
* CHANGE - Small bug fixes

= 1.15.0 - 2024-04-03 =
* NEW - Added compatibility with the WooCommerce Checkout Block
* CHANGE - Enable restriction features on product tags
* CHANGE - Improve compatibility with DooFinder
* CHANGE - Mark the plugin as compatible with HPOS
...
= 1.14.1 - 2022-09-06 =
* CHANGE - Allow to use a custom base country for the state restrictions
* CHANGE - Compatibility with WC 6.8

= 1.14.0 - 2022-07-26 =
* CHANGE - Improve compatibility with WC shortcodes
* NEW - Add shortcode [wccr_current_country]

= 1.13.1 - 2022-05-25 =
* CHANGE - Cache support - Don't hide the variation attributes when the product is restricted

= 1.13.0 - 2022-03-01 =
* NEW - Allow to display custom page in category pages
* NEW - Compatibility with WCFM
* CHANGE - Support for the plugin "PW Woocommerce Advanced Gift Rules"
* CHANGE - Support for the plugin "Aelia Currency Switcher for WooCommerce"
* CHANGE - Add option to not allow to close the popup selector without selecting a country
* CHANGE - MInor improvements for the country selector
* CHANGE - Upgraded Freemius SDK to v2.4.3
* FIX - When we edited a category with category-only restrictions, it was removing the custom restrictions from products using the category
* FIX - Sometimes the categories aren't restricted in some listings

= 1.12.3 - 2021-07-01 =
* CHANGE - Selector - Allow to display abbreviations
* CHANGE - Selector - Automatically change the currency for the plugin "price based on country" by Oscar Gare

= 1.12.2 - 2021-05-12 =
* FIX - Country selector does not load sometimes
* FIX - States restrictions don't apply correctly when we update the state in the cart page
